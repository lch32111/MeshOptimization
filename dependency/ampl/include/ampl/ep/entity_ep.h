...
struct EntityRefPointer {
  std::size_t count_;
  std::map<TupleRef, Instance *>::iterator it_;
  EntityRefPointer(size_t count,
                   const std::map<TupleRef, Instance *>::iterator &it)
      : count_(count), it_(it) {}
};
...
AMPLAPI const char *AMPL_EntityBase_type(EntityBase *impl,
                                         ErrorInformation *errorInfo);
AMPLAPI std::size_t AMPL_EntityBase_indexarity(EntityBase *impl,
                                               ErrorInformation *errorInfo);
AMPLAPI const char **AMPL_EntityBase_getIndexingSets(
    EntityBase *impl, std::size_t *n, ErrorInformation *errorInfo);

AMPLAPI const char **AMPL_EntityBase_xref(EntityBase *impl, std::size_t *n,
                                          ErrorInformation *errorInfo);

AMPLAPI void AMPL_EntityBase_getValues(EntityBase *impl,
                                       const char *const *suffixes,
                                       std::size_t num_suffixes,
                                       DataFrame *output,
                                       ErrorInformation *errorInfo);

AMPLAPI void AMPL_EntityBase_setValues(EntityBase *impl, DataFrame *data,
                                       ErrorInformation *errorInfo);
...
AMPLAPI const Tuple *AMPL_Entity_getTuples(EntityBase *impl, std::size_t *size);

// ************* Iterators *************
AMPLAPI Tuple AMPL_Entity_iterator_getPointer(EntityRefPointer *it1,
                                              Instance **instance);
AMPLAPI EntityRefPointer *AMPL_Entity_begin(EntityBase *impl,
                                            ErrorInformation *errorInfo);
AMPLAPI EntityRefPointer *AMPL_Entity_end(EntityBase *impl,
                                          ErrorInformation *errorInfo);
AMPLAPI EntityRefPointer *AMPL_Entity_find(EntityBase *impl, Tuple t,
                                           ErrorInformation *errorInfo);
AMPLAPI void AMPL_Entity_iterator_increment(EntityRefPointer *it,
                                            ErrorInformation *errorInfo);
AMPLAPI void AMPL_Entity_iterator_delete(EntityRefPointer *it);
AMPLAPI bool AMPL_Entity_iterator_equal(EntityRefPointer *it1,
                                        EntityRefPointer *it2,
                                        ErrorInformation *errorInfo);
...
// *************  Parameter *************
AMPLAPI Tuple AMPL_Parameter_iterator_getPointer(EntityRefPointer *it1,
                                                 Variant **instance);
...
AMPLAPI void AMPL_Parameter_setValuesMatrix(Parameter *impl, std::size_t nr,
                                            ...
                                            AMPLArgs cols, const double *values,
                                            bool transpose,
                                            ErrorInformation *errorInfo);
...
// *************  Objective *************
AMPLAPI int AMPL_Objective_sense(Objective *impl, ErrorInformation *errorInfo);
...
// ************* Table *************
AMPLAPI void AMPL_Table_read(Table *impl, ErrorInformation *errorInfo);
AMPLAPI void AMPL_Table_write(Table *impl, ErrorInformation *errorInfo);
...
class EntityWrapper {
 ...
 public:
  ...
  typedef internal::EntityRefPointer *ReferencePointer;
  ...
  static ValueType getPointer(ReferencePointer it) {
    ...
    internal::Tuple t =
        internal::AMPL_Entity_iterator_getPointer(it, &instance);
...
// Template specialization which wraps all the procedures regarding instance
// access and iterators for Parameter
template <>
class EntityWrapper<VariantRef> {
 ...
 public:
  ...
  static ValueType getPointer(ReferencePointer it) {
    ...
    internal::Tuple t =
        internal::AMPL_Parameter_iterator_getPointer(it, &instance);
