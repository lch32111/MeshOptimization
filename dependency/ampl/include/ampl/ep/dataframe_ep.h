...
extern "C" {
AMPLAPI int AMPL_DataFrame_Equals(DataFrame* df1, DataFrame* df2,
...
AMPLAPI void AMPL_DataFrame_reserve(DataFrame* dataframe, std::size_t numRows,
                                    ErrorInformation* errorInfo);
AMPLAPI void AMPL_DataFrame_addRow(DataFrame* dataframe, Tuple value1,
                                   ErrorInformation* errorInfo);

AMPLAPI void AMPL_DataFrame_setColumn_arg(DataFrame* dataframe,
                                          const char* header, AMPLArgs column,
                                          std::size_t n,
                                          ErrorInformation* errorInfo);
...
AMPLAPI void AMPL_DataFrame_addColumn(DataFrame* dataframe, const char* header,
                                      AMPLArgs values,
                                      ErrorInformation* errorInfo);
...
AMPLAPI void AMPL_DataFrame_setValue(DataFrame* dataframe, Tuple rowIndex,
                                     const char* header, Variant value,
                                     ErrorInformation* errorInfo);
