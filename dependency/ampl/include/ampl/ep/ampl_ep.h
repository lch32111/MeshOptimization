...
inline void defaultOutputHandlerFunction(output::Kind kind, const char *msg,
                                         void *oh) {
  static_cast<OutputHandler *>(oh)->output(kind, msg);
}
inline void defaultErrorHandlerFunction(bool isWarning, const char *filename,
                                        int row, int offset,
...
inline void runCallback(void *cb) { static_cast<Runnable *>(cb)->run(); }
...
AMPLAPI EntityMap<Constraint> *AMPL_Impl_getConstraints(
    AMPL *ampl, ErrorInformation *errorInfo);
AMPLAPI EntityMap<Parameter> *AMPL_Impl_getParameters(
    AMPL *ampl, ErrorInformation *errorInfo);
AMPLAPI EntityMap<Objective> *AMPL_Impl_getObjectives(
    AMPL *ampl, ErrorInformation *errorInfo);
...
AMPLAPI void AMPL_Impl_evalAsync(AMPL *ampl, const char *amplstatement,
                                 RunnablePtr function, void *cb,
                                 ErrorInformation *errorInfo);
AMPLAPI void AMPL_Impl_solveAsync(AMPL *ampl, RunnablePtr function, void *cb,
                                  ErrorInformation *errorInfo);
...
AMPLAPI void AMPL_Impl_setDblOption(AMPL *ampl, const char *name, double value,
                                    ErrorInformation *errorInfo);
AMPLAPI int AMPL_Impl_getIntOption(AMPL *ampl, const char *name, bool *exists,
                                   ErrorInformation *errorInfo);
...
AMPLAPI void AMPL_Impl_setOutputHandler(AMPL *ampl, void *outputhandler,
                                        OutputHandlerCbPtr callback);
