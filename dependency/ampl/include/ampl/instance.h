 ...
 * <p>
 * All %AMPL suffixes for an algebraic variable are available through methods
 * with the same name in this class. See
 * http://www.ampl.com/NEW/suffbuiltin.html for a list of the available
 * suffixes. <p> All the accessors in this class throw an std::runtime_error if
 * the instance has been deleted in the underlying %AMPL interpreter.
 */
